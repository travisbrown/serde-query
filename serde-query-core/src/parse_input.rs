...
Query { id: QueryId(Ident { sym: with_multiple_queries, span: bytes(95..116) }), fragment: Field { name: "y", quoted: false, optional: None, rest: Accept }, ty: TokenStream [Ident { sym: i32, span: bytes(118..121) }] }
"#
        );
        snapshot!(
